...
The project uses [cargo-tarpaulin](https://github.com/xd009642/tarpaulin) for code coverage analysis. Coverage reports are automatically generated by GitHub Actions and uploaded to [Codecov](https://codecov.io/gh/tomas-rampas/xbrl_api_client).
...
This will generate a code coverage report in the terminal. For more options, such as generating HTML reports, refer to the cargo-tarpaulin documentation.
